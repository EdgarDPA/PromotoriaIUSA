                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <span class="iusa_sidebar">
                                    <img class="logo_iusa_sidebar" src="{{asset('img/iusa.png')}}">
                                </span>
                            </li>
                            ...
                            <li>
                                <a href="upload_csv" class="waves-effect waves-primary">
                                    <i class="fa fa-upload"></i><span> Cargar CSV </span>
                                </a>
                            </li>

                            <li>
                                <a href="estadistica" class="waves-effect waves-primary">
                                    <i class="fa fa-chart-area"></i><span> Estadística </span>
                                </a>
                            </li>

                            <li>
                                <a href="{{url('opportunities')}}" class="waves-effect waves-primary">
                                    <i class="fa fa-handshake-o"></i><span> Oportunidades</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="https://iusa.com.mx/assets/descargables/catalogo-de-construccion.pdf" target="_blank" class="waves-effect waves-primary">
                                    <i class="fa fa-file-pdf-o"></i><span> Catálogo </span>
                                </a>
                            </li>
